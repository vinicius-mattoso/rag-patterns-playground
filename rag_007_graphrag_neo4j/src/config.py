"""Configuration loading for the Neo4j GraphRAG module."""
...
def load_config() -> AppConfig:
    ...
    return AppConfig(
        ...
        allowed_nodes=_parse_csv_list(os.getenv("ALLOWED_NODES")),
        allowed_relationships=_parse_csv_list(os.getenv("ALLOWED_RELATIONSHIPS")),
