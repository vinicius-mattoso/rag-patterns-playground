"""Pipeline orchestration for ontology-guided Neo4j GraphRAG."""
...
def query_graph(question: str, pipeline: GraphPipeline, config: AppConfig) -> GraphQueryResult:
    ...
    return run_query(chain=pipeline.chain, graph=pipeline.graph, question=question, context_limit=config.context_limit)
